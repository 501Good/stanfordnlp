...
def train(args):
    ...
    model_file = args['save_dir'] + '/' + args['save_name'] if args['save_name'] is not None \
            else '{}/{}_ner.pt'.format(args['save_dir'], args['shorthand'])
        ...
        for i, batch in enumerate(train_batch):
            ...
            if global_step % args['eval_interval'] == 0:
                ...
                for batch in dev_batch:
                    ...
                    dev_preds += preds
                dev_batch.conll.set(['xpos'], [y for x in dev_preds for y in x])
...
def evaluate(args):
    ...
    batch.conll.set(['xpos'], [y for x in preds for y in x])
